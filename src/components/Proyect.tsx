  ...
  return (
    <>
      <div className={`shadow-lg shadow-neutral-400 relative cursor-pointer rounded-lg h-56 transform duration-300 dark:shadow-md hover:-translate-y-2 ${accordion ? 'mb-40 ' : 'mb-0'}`} onClick={openAccordion}>
        ...
        <div className={`${accordion ? 'translate-y-44' : ''} bg-adriPink h-52 overflow-hidden flex justify-center items-center flex-col rounded-lg transform transition duration-500 ease-in-out z-20 mb-4 shadow-lg shadow-neutral-400 dark:shadow-lg`}>
